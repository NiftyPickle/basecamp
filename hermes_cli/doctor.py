...
def run_doctor(args):
    ...
    if soul_path.exists():
        ...
        check_warn(f"{_DHH}/SOUL.md not found", "(create it to give Basecamp a custom personality)")
        if should_fix:
            soul_path.parent.mkdir(parents=True, exist_ok=True)
            soul_path.write_text(
                "# Basecamp Persona\n\n"
                "<!-- Edit this file to customize how Basecamp communicates. -->\n\n"
                "You are Basecamp, a helpful AI assistant.\n",
                encoding="utf-8",
            )

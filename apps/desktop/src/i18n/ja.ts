...
export const ja = defineLocale({
  ...
  settings: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Basecamp がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
    ...
    gateway: {
      ...
      localDesc: 'ローカルホストでプライベートな Basecamp バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
  ...
  onboarding: {
    headerTitle: 'Basecamp のセットアップをしましょう',

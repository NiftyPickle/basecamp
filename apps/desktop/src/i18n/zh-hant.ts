...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    errors: {
      ...
      gatewayUnreachable: '無法連接閘道，連線持續中斷。',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew:
      '按 cron 表達式排程一個提示詞。Basecamp 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `已在瀏覽器中開啟 ${provider}。請在那裡授權 Basecamp，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Basecamp 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      ...
      stillWorking:
        'Basecamp 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',

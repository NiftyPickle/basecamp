...
export const zh: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      gatewayUnreachable: '无法连接网关，连接持续中断。',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      bluebubbles: '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Basecamp 指向该 URL。',
      ...
      weixin: '登录微信公众平台，复制 AppID 和 Token，并把消息回调 URL 指向 Basecamp。',

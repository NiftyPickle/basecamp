...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Basecamp…'
    },
    errors: {
      ...
      gatewayUnreachable: 'Could not reach the gateway. The connection keeps dropping.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Basecamp.',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Basecamp starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Basecamp backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      restartingMessage: 'Basecamp will reconnect using the saved settings.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Basecamp' },
  ...
  updates: {
    ...
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Basecamp reconnects automatically when it’s back.',
  ...
  install: {
    ...
    settingUpTitle: 'Setting up Basecamp',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Basecamp instance is running. Stop any running Basecamp instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you set up with Basecamp",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Basecamp v${version}`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Basecamp to use Save Image.',
    restartToSaveImages: 'Restart Basecamp to save images',

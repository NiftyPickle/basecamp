...
const BASECAMP_PINE = '#2F6B4F'
const BASECAMP_PINE_DARK = '#5FB389'

const pineTint = (pct: number) => `color-mix(in srgb, ${BASECAMP_PINE} ${pct}%, #FFFFFF)`
const pineTintTransparent = (pct: number) => `color-mix(in srgb, ${BASECAMP_PINE} ${pct}%, transparent)`

/**
 * Basecamp — the shipped desktop identity. Warm stone neutrals grounded by a
 * summit-pine accent, so the chrome reads calm and outdoorsy rather than the
 * cool Nous blue. Dark variant keeps the same pine seed lifted for contrast.
 */
export const basecampTheme: DesktopTheme = {
  name: 'basecamp',
  label: 'Basecamp',
  description: 'Warm stone neutrals with summit-pine accents',
  colors: {
    background: '#FAF8F4',
    foreground: '#1E1C18',
    card: '#FFFFFF',
    cardForeground: '#1E1C18',
    muted: '#F0ECE4',
    mutedForeground: '#6B6458',
    popover: '#FFFFFF',
    popoverForeground: '#1E1C18',
    primary: BASECAMP_PINE,
    primaryForeground: '#FBFDFB',
    secondary: '#EFEADF',
    secondaryForeground: '#2A2820',
    accent: pineTint(12),
    accentForeground: '#1F2A24',
    border: '#E2DCD0',
    input: '#D8D1C2',
    ring: BASECAMP_PINE,
    midground: BASECAMP_PINE,
    composerRing: BASECAMP_PINE,
    destructive: '#C04A2B',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3EFE7',
    sidebarBorder: '#E4DED2',
    userBubble: pineTint(10),
    userBubbleBorder: pineTintTransparent(28)
  },
  darkColors: {
    background: '#16140F',
    foreground: '#ECE6DA',
    ...
    primary: BASECAMP_PINE_DARK,
    primaryForeground: '#0E1611',
    secondary: '#2C2820',
    secondaryForeground: '#D8D1C2',
    accent: '#243027',
    accentForeground: '#C9E2D3',
    border: '#332E24',
    input: '#332E24',
    ring: BASECAMP_PINE_DARK,
    midground: BASECAMP_PINE_DARK,
    composerRing: BASECAMP_PINE_DARK,
    destructive: '#D5603F',
    destructiveForeground: '#FEF2F0',
    sidebarBackground: '#100E0A',
    sidebarBorder: '#2A261D',
    userBubble: '#22281F',
    userBubbleBorder: '#3A4A3D'
  }
}

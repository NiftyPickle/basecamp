...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Basecamp, built on the Hermes Agent platform (by Nous Research). "
    "When the user needs help with Basecamp itself — configuring, setting up, using, "
    "extending, or troubleshooting it — or when you need to understand your own "
    "features, tools, or capabilities, "

...
export function resolvePageTitle(
  ...
  // Routes not in the i18n nav map. Without these, the fallback derives the
  // title from the URL slug ("/sidekick" -> "Sidekick"), which mismatches the
  // sidebar label and in-page branding.

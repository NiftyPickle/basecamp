...
export function Backdrop() {
  return (
    <>
      ...
      {/* Subtle top-left glow only. The marble filler-bg texture and the
          SVG noise grain were removed for a flat, modern Discord/Claude-
          style surface. */}
      <div
        aria-hidden
        ...
        style={{
          background:
            "radial-gradient(ellipse at 0% 0%, transparent 70%, var(--warm-glow) 100%)",
